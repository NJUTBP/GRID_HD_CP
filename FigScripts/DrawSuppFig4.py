...
def main_HD():
    ...
    no=-1
    pathHD='../Data/HD/ProcessedData/DetectCP_continuous/'
    ...
    plt.savefig('../Figures/SuppFigure4_HD_part1.png',format='PNG',dpi=300)
    plt.show()
    plt.close()
    ...
    plt.savefig('../Figures/SuppFigure4_HD_part2.png',format='PNG',dpi=300)
    plt.show()
    plt.close()
...
def main_GC():
    fig=plt.figure(figsize=(11,8.5))
    pathGC1='../Data/GC1/DetectCP_continuous/'
    ...
    pathGC2='../Data/GC2/DetectCP_continuous/'
    ...
    plt.savefig('../Figures/SuppFigure4_GC1&2.png',format='PNG',dpi=300)
    plt.show()
    plt.close()
